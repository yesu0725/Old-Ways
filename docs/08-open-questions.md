...
### Q11 — Server-required is acceptable?
The server-authoritative Proven decision ([07](07-technical-architecture.md)) makes the mod
**server-required** rather than optional-per-client. Every TaegukGaming member needs it installed.
Confirm that's acceptable before Phase 1 locks it in — the alternative is a client-trusted counter,
which defeats the point of Proven.
→ [07](07-technical-architecture.md), [09](09-roadmap.md) Phase 1.
...
|---|---|---|---|
| Q1 | Reaction curve intensity | **Steady curve** scaling with mastery, **per player** — never global or server-wide → [04](04-boss-reactions.md) | 2026-08-06 |
